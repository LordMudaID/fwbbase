...
bot_token = os.environ.get("BOT_TOKEN", "5976774379:AAGl_UVqa7Z7ctX11wBrekxtX1TH6QwZwb8")
# =========================================================== #

db_url = os.environ.get("DB_URL", "mongodb+srv://owl:<password>@fwb.ouw7bsq.mongodb.net/?retryWrites=true&w=majority")
